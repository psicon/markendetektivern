...
def preprocess(
    ...
    Args:
      ...
      max_dim: cap the longer edge AFTER preprocessing (2000 default).
        Lower = faster upload + faster OCR. 2000 is a good balance for
        receipt OCR (text remains crisp at typical phone-camera angles).
        Drop to 1600 for max speed; raise to 2500-3500 if your bons have
        unusually dense small print.
