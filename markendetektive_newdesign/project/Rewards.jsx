      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 14 }}>
          ...
          <button onClick={() => setHelpOpen(true)} aria-label="So funktioniert's" style={{
            ...
            background: 'var(--th-primary-tint-strong)', color: COLORS.primary, border: 0, cursor: 'pointer',
            font: `700 12px ${F}`,
        ...
        <div style={{
          display: 'flex', gap: 4, background: 'var(--th-low)', padding: 3, borderRadius: 12,
        }}>
...
function TabBtn({ active, onClick, label, icon }) {
  return (
    <button onClick={onClick} style={{
      ...
      background: active ? 'var(--th-card)' : 'transparent',
  ...
  return (
    <>
      ...
      <div style={{ padding: '4px 20px 0' }}>
        <div style={{
          ...
          <div style={{ height: 8, background: 'rgba(255,255,255,.22)', borderRadius: 4, overflow: 'hidden', marginTop: 10 }}>
            <div style={{ width: `${pct}%`, height: '100%', background: 'var(--th-card)', borderRadius: 4, transition: 'width .3s' }}/>
          </div>
      ...
      <div style={{ padding: '22px 20px 0' }}>
        ...
        <div style={{ background: 'var(--th-card)', borderRadius: 14, border: '1px solid var(--th-border)', overflow: 'hidden', marginTop: 10 }}>
          {CASHBACK_EARN.map((e, i) => (
            <div key={e.k} onClick={e.k === 'receipt' ? onOpenReceipts : e.k === 'photo' ? onOpenPhotos : undefined} style={{
              ...
              <div style={{
                width: 40, height: 40, borderRadius: 10, background: 'var(--th-primary-tint-strong)',
                ...
                {e.limitLabel && (
                  <div style={{
                    ...
                    <span style={{
                      ...
                      background: e.available ? 'var(--th-primary-tint-strong)' : 'rgba(220,38,38,.1)',
                    ...
                    {typeof e.limitProgress === 'number' && (
                      <div style={{ flex: 1, height: 4, background: 'var(--th-border)', borderRadius: 2, overflow: 'hidden' }}>
                        <div style={{
                  ...
                  <div style={{ display: 'flex', flexWrap: 'wrap', gap: 4, marginTop: 8 }}>
                    {PHOTO_WIZARD_STEPS.map(s => (
                      <span key={s.n} style={{
                        ...
                        background: 'var(--th-divider)', padding: '3px 7px', borderRadius: 4,
                      }}>
...
function CatChip({ active, onClick, icon, label }) {
  return (
    <button onClick={onClick} style={{
      ...
      background: active ? COLORS.primary : 'var(--th-card)',
      color: active ? '#fff' : COLORS.text,
      border: active ? '1px solid transparent' : '1px solid var(--th-border-md)',
...
function RewardCard({ r, canRedeem }) {
  return (
    <div style={{
      background: 'var(--th-card)', borderRadius: 14, overflow: 'hidden',
      ...
      <div style={{
        ...
        <div style={{
          minWidth: 56, height: 44, borderRadius: 8, background: 'var(--th-card)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
          ...
          {PERIODS.map(p => {
            ...
            return (
              <button key={p.k} onClick={() => setPeriod(p.k)} style={{
                ...
                color: on ? 'var(--th-card)' : COLORS.muted,
      ...
      <div style={{ padding: '18px 20px 0' }}>
        ...
        {scope === 'friends' && (
          <button style={{
            ...
            background: 'var(--th-card)', color: COLORS.primary,
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 12, position: 'relative' }}>
        <div style={{
          width: 54, height: 54, borderRadius: '50%', background: 'var(--th-card)',
          display: 'flex', alignItems: 'center', justifyContent: 'center',
      ...
      <div style={{ marginTop: 14, position: 'relative' }}>
        ...
        <div style={{ height: 7, background: 'rgba(255,255,255,.22)', borderRadius: 4, overflow: 'hidden', marginTop: 8 }}>
          <div style={{ width: `${DET_LEVEL.pct}%`, height: '100%', background: 'var(--th-card)', borderRadius: 4 }}/>
        </div>
      </div>
...
function SegCtrl({ options, value, onChange, size = 'md' }) {
  ...
  return (
    <div style={{ display: 'flex', background: 'var(--th-low)', padding: 3, borderRadius: 12, gap: 3 }}>
      {options.map(o => {
        const on = value === o.k;
        return (
...
function AchievementCard({ a }) {
  ...
  return (
    <div style={{
      flexShrink: 0, width: 150, background: 'var(--th-card)', borderRadius: 14,
      border: `1px solid ${done ? a.color + '44' : 'var(--th-border)'}`,
...
function Podium({ rows }) {
  if (rows.length < 3) {
    return (
      <div style={{ background: 'var(--th-card)', borderRadius: 14, padding: 6, border: '1px solid var(--th-border)' }}>
...
function LbRow({ rank, row, first, last }) {
  ...
  return (
    <div style={{
      ...
      <div style={{
        width: 36, height: 36, borderRadius: '50%', background: 'var(--th-card)',
        border: `1.5px solid ${isMe ? COLORS.primary : 'var(--th-border-md)'}`,
        display: 'flex', alignItems: 'center', justifyContent: 'center',
