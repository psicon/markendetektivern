  ...
  return portalToSheetHost(
    <div onClick={onClose} style={{
      ...
      <div onClick={(e) => e.stopPropagation()} style={{
        width: '100%', background: 'var(--th-bg)',
        ...
        <div style={{ padding: '0 20px 14px', display: 'flex', alignItems: 'center', gap: 12 }}>
          ...
          <button onClick={onClose} style={{
            width: 32, height: 32, borderRadius: 16, border: 0, background: 'var(--th-border)',
        ...
        {onOpenHelp && (
          <div style={{ padding: '6px 20px 0' }}>
            <button onClick={() => { onClose(); onOpenHelp(); }} style={{
              ...
              background: 'var(--th-primary-tint)', color: RH_C.primary,
              font: `700 13px ${RH_F}`,
...
function RewardsHelpPage({ onBack, onResetOnboarding }) {
  ...
  return (
    <div style={{ fontFamily: RH_F, background: 'var(--th-bg)', minHeight: '100%', paddingBottom: 110 }}>
      ...
      <div style={{ padding: '0 20px' }}>
        <button onClick={() => { onResetOnboarding && onResetOnboarding(); }} style={{
          width: '100%', background: 'var(--th-card)', borderRadius: 14, padding: '14px 14px',
