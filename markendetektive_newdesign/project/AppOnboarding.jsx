...
function AppOnboarding({ onDone }) {
  ...
  return aoPortal(
    <div style={{
      ...
      {showTopChrome && (
        <div style={{ padding: '56px 20px 6px', flexShrink: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{
              flex: 1, height: 6, background: 'rgba(25,28,29,.08)', borderRadius: 3, overflow: 'hidden',
            }}>
              <div style={{
      ...
      {/* Bottom CTA */}
      {showBottomCTA && (
        <div style={{ padding: '14px 20px 28px', background: '#F9FAFB', flexShrink: 0 }}>
    ...
    <div style={{
      ...
      <div style={{ position: 'relative', flex: 1, display: 'flex', flexDirection: 'column', padding: '60px 28px 28px' }}>
        ...
        <div style={{ textAlign: 'center', marginTop: 20 }}>
          ...
          <div style={{
            font: `500 14px ${AO_F}`, color: 'rgba(255,255,255,.85)',
        ...
        {COUNTRIES.map((c) => {
          ...
          return (
            <button key={c.k} onClick={() => setCountry(c.k)} style={{
              ...
              background: on ? '#e8f5f2' : '#fff',
              border: `2px solid ${on ? AO_C.primary : 'rgba(25,28,29,.08)'}`,
    ...
    <div style={{ padding: '10px 24px 24px' }}>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12, marginTop: 22 }}>
        ...
        <button onClick={() => setAccountChoice('register')} style={{
          ...
          border: `2px solid ${accountChoice === 'register' ? AO_C.primary : 'rgba(25,28,29,.08)'}`,
          cursor: 'pointer', position: 'relative',
        ...
        <button onClick={() => setAccountChoice('guest')} style={{
          ...
          border: `2px solid ${accountChoice === 'guest' ? AO_C.primary : 'rgba(25,28,29,.08)'}`,
          cursor: 'pointer', position: 'relative',
          display: 'flex', flexDirection: 'column', gap: 6, alignItems: 'flex-start',
          textAlign: 'left',
          transition: 'all .2s',
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10, width: '100%' }}>
            <div style={{
              width: 36, height: 36, borderRadius: 10, background: 'rgba(25,28,29,.06)',
              display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0,
            }}>
        ...
        {OB_MARKETS.map((m) => {
          ...
          return (
            <button key={m.k} onClick={() => toggle(m.k)} style={{
              ...
              border: `2px solid ${on ? AO_C.primary : 'rgba(25,28,29,.06)'}`,
              cursor: 'pointer', position: 'relative',
  ...
  return (
    <div style={{ padding: '10px 24px 24px' }}>
      ...
      <div style={{
        ...
        border: '1px solid rgba(25,28,29,.06)', marginTop: 18,
      }}>
        ...
        <div style={{ position: 'relative', height: 36, marginTop: 22 }}>
          <div style={{ position: 'absolute', left: 0, right: 0, top: 16, height: 6,
            borderRadius: 3, background: 'rgba(25,28,29,.08)', pointerEvents: 'none' }}/>
        ...
        {presets.map((p) => {
          ...
          return (
            <button key={p} onClick={() => setValue(p)} style={{
              ...
              background: on ? AO_C.primary : '#fff',
              color: on ? '#fff' : AO_C.text,
              border: `1px solid ${on ? AO_C.primary : 'rgba(25,28,29,.08)'}`,
  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        background: 'rgba(25,28,29,.08)', marginTop: 20, overflow: 'hidden',
      }}>
        <div style={{
...
function StepReveal({ answers }) {
  ...
  return (
    <div style={{ position: 'relative', padding: '10px 24px 24px' }}>
      ...
      {/* Big savings card */}
      <div style={{
        background: '#fff', borderRadius: 20, padding: '24px 20px', marginTop: 24,
        border: '1px solid rgba(25,28,29,.06)', textAlign: 'center',
      ...
      <div style={{ display: 'flex', gap: 10, marginTop: 12 }}>
        <div style={{
          flex: 1, background: '#fff', borderRadius: 16, padding: '18px 14px',
          border: '1px solid rgba(25,28,29,.06)', textAlign: 'center',
        }}>
