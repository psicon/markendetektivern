      ...
      <div style={{ display: 'flex', gap: 3 }}>
        {[1,2,3,4,5].map(n => (
          <span key={n} style={{
            ...
            background: n <= value ? RS_C.primary : 'rgba(25,28,29,.1)',
          }}/>
        ))}
      </div>
...
function ReviewCard({ r, showSimilarity }) {
  ...
  return (
    <div style={{
      ...
      <div style={{ paddingTop: 8, borderTop: '1px solid rgba(25,28,29,.06)' }}>
    ...
    <div onClick={handleClose} style={{
      ...
      <div onClick={(e)=>e.stopPropagation()} style={{
          ...
          {view === 'list' ? (
            <>
              ...
              <div style={{
                ...
                <div style={{ textAlign: 'center', borderRight: '1px solid rgba(25,28,29,.08)', paddingRight: 16 }}>
                  ...
                  {distribution.map(({ n, count }) => {
                    ...
                    return (
                      <div key={n} style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '2px 0' }}>
                        ...
                        <div style={{ flex: 1, height: 6, borderRadius: 3, background: 'rgba(25,28,29,.08)', overflow: 'hidden' }}>
              ...
              {/* Category averages */}
              <div style={{
                background: '#fff', borderRadius: 14, padding: '8px 14px', marginBottom: 14,
                border: '1px solid rgba(25,28,29,.06)',
              }}>
            ...
            submitted ? (
              ...
              <>
                ...
                <div style={{
                  ...
                  marginBottom: 12, border: '1px solid rgba(25,28,29,.06)',
                  textAlign: 'center',
                }}>
                ...
                <div style={{
                  ...
                  marginBottom: 16, border: '1px solid rgba(25,28,29,.06)',
                }}>
                  ...
                  <textarea
                    ...
                    style={{
                      ...
                      border: '1px solid rgba(25,28,29,.12)', borderRadius: 10,
        ...
        <div style={{
          ...
          borderTop: '1px solid rgba(25,28,29,.08)',
          background: '#fff',
          display: 'flex', gap: 10,
        }}>
          {view === 'list' ? (
            ...
            <>
              <button onClick={() => { reset(); setView('list'); }} style={{
                ...
                background: '#fff', color: RS_C.text,
                border: '1px solid rgba(25,28,29,.12)', cursor: 'pointer',
                font: `700 14px ${RS_F}`,
              }}>Abbrechen</button>
