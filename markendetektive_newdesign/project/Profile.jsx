...
function Profile({ onBack, onOpenProduct, onOpenRewards, onOpenReceiptScan, initialView = 'main' }) {
  ...
  return (
    <div style={{ background: 'var(--th-bg)', minHeight: '100%', paddingBottom: 110, fontFamily: F }}>
...
function ProfileMain({ onBack, go }) {
  return (
    <>
          ...
          <div style={{
            ...
            <div style={{ marginTop: 12, position: 'relative' }}>
              ...
              <div style={{ height: 5, background: 'rgba(255,255,255,.22)', borderRadius: 3, overflow: 'hidden' }}>
                <div style={{ width: `${PROFILE.level.pct}%`, height: '100%', background: 'var(--th-card)', borderRadius: 3 }}/>
              </div>
            </div>
          </div>
        </button>
      ...
      {/* Menu list */}
      <div style={{ padding: '18px 20px 0' }}>
        <div style={{ background: 'var(--th-card)', borderRadius: 14, border: '1px solid var(--th-border)', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '18px 20px 0' }}>
        <button style={{
          ...
          background: 'var(--th-card)', color: '#dc2626',
...
function LocBadge({ icon, label }) {
  return (
    <span style={{
      ...
      background: 'var(--th-primary-tint)', color: COLORS.primary,
      font: `700 10px ${F}`,
    }}>
...
function ToggleRow({ icon, label, defaultOn, first, last, value, onChange }) {
  ...
  return (
    <button onClick={toggle} style={{
      width: '100%', background: 'var(--th-card)', border: 0, cursor: 'pointer',
      padding: '14px 14px', display: 'flex', alignItems: 'center', gap: 12,
      borderTop: first ? 'none' : '1px solid var(--th-divider)',
      textAlign: 'left',
    }}>
      <div style={{
      ...
      <div style={{
        ...
        <div style={{
          ...
          background: 'var(--th-card)', boxShadow: '0 1px 2px rgba(0,0,0,.2)',
          transition: 'left .15s',
        }}/>
      </div>
    </button>
  ...
  return (
    <>
      ...
      <div style={{ padding: '20px 20px 0' }}>
        ...
        <div style={{
          display: 'flex', alignItems: 'center', gap: 14, background: 'var(--th-card)',
          borderRadius: 14, padding: '14px', border: '1px solid var(--th-border)',
        }}>
          <div style={{
      ...
      <div style={{ padding: '18px 20px 0' }}>
        ...
        <div style={{
          background: 'var(--th-card)', borderRadius: 14, padding: 10,
          ...
          {Object.entries(MARKETS).map(([k, m]) => {
            ...
            return (
              <button key={k} onClick={() => toggleMarket(k)} disabled={disabled} style={{
                ...
                background: on ? m.tint : 'var(--th-low)',
                color: on ? 'var(--th-card)' : (disabled ? COLORS.muted : COLORS.text),
                border: on ? 'none' : '1px solid var(--th-border-md)',
                font: `700 13px ${F}`,
      ...
      <div style={{ padding: '18px 20px 0' }}>
        ...
        <div style={{ display: 'flex', gap: 6, background: 'var(--th-low)', padding: 3, borderRadius: 11 }}>
          {[
      ...
      <div style={{ padding: '18px 20px 0' }}>
        ...
        <div style={{
          background: 'var(--th-low)', borderRadius: 11, padding: '12px 14px',
          display: 'flex', alignItems: 'center', gap: 10,
          border: '1px solid var(--th-border)',
        }}>
...
function Field({ value, onChange, icon, placeholder, type = 'text' }) {
  return (
    <div style={{
      background: 'var(--th-card)', borderRadius: 11, padding: '0 14px',
    ...
    <>
      ...
      <div style={{ padding: '20px 20px 0' }}>
        {SHOP_LISTS.map((l, i) => {
          ...
          return (
            <div key={i} style={{
              background: 'var(--th-card)', borderRadius: 14, padding: '14px 14px',
              border: '1px solid var(--th-border)', marginBottom: 10,
              display: 'flex', alignItems: 'center', gap: 12,
            }}>
              <div style={{
              ...
              <div style={{ flex: 1, minWidth: 0 }}>
                ...
                <div style={{ height: 4, background: 'var(--th-border)', borderRadius: 2, overflow: 'hidden', marginTop: 6 }}>
            ...
            <button key={id} onClick={() => onOpenProduct && onOpenProduct(product)} style={{
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  background: 'var(--th-card)', display: 'flex', alignItems: 'center', justifyContent: 'center',
  ...
  return (
    <>
      ...
      <div style={{ padding: '16px 20px 0' }}>
        <div style={{
          background: 'var(--th-primary-tint)', borderRadius: 12, padding: '10px 14px',
          display: 'flex', alignItems: 'center', gap: 10,
        }}>
          ...
          {HIST_PURCHASE.map((h, i) => {
            ...
            return (
              <button key={i} onClick={() => onOpenProduct && onOpenProduct(product)} style={{
                ...
                borderTop: i === 0 ? 'none' : '1px solid var(--th-divider)',
                textAlign: 'left',
              }}>
                <div style={{
...
function ProfileLog({ onBack }) {
  ...
  return (
    <>
      ...
      <div style={{ padding: '16px 20px 0' }}>
        <div style={{ display: 'flex', background: 'var(--th-low)', padding: 3, borderRadius: 11, gap: 3 }}>
          ...
          {tab === 'scan' && HIST_SCAN.map((h, i) => {
            ...
            return (
              <div key={i} style={{
                ...
                <div style={{
                  width: 34, height: 34, borderRadius: 9,
                  background: p.tint ? `linear-gradient(135deg,${p.tint[0]},${p.tint[1]})` : 'var(--th-low)',
                  display: 'flex', alignItems: 'center', justifyContent: 'center',
    ...
    <>
      ...
      <div style={{ padding: '18px 20px 0' }}>
        {HIST_RATINGS.map((r, i) => {
          ...
          return (
            <button key={i} onClick={() => onOpenProduct && onOpenProduct(product)} style={{
              width: '100%', background: 'var(--th-card)', border: '1px solid var(--th-border)',
    ...
    <>
          ...
          <div style={{ marginTop: 14 }}>
            ...
            <div style={{ height: 6, background: 'rgba(255,255,255,.22)', borderRadius: 3, overflow: 'hidden' }}>
              <div style={{
                ...
                height: '100%', background: 'var(--th-card)', borderRadius: 3,
              }}/>
            </div>
          </div>
        </div>
      ...
      <div style={{ padding: '12px 20px 0' }}>
        <button onClick={limitReached ? undefined : onStartWizard} disabled={limitReached} style={{
          ...
          background: limitReached ? 'var(--th-low)' : '#7c3aed',
          ...
          {tabs.map(t => {
            ...
            return (
              <button key={t.k} onClick={() => setFilter(t.k)} style={{
                ...
                background: on ? '#7c3aed' : 'var(--th-card)',
                color: on ? 'var(--th-card)' : COLORS.text,
      ...
      <div style={{ padding: '18px 20px 0' }}>
        ...
        <input
          ...
          style={{
            ...
            border: `1px solid ${nameOk ? 'rgba(22,163,74,.45)' : 'var(--th-border-md)'}`,
      ...
      <div style={{ padding: '18px 20px 0' }}>
        <button
          ...
          style={{
            ...
            background: nameOk ? '#7c3aed' : 'var(--th-low)',
    ...
    <div style={{ position: 'absolute', inset: 0, background: '#0f0f0f', color: '#fff', display: 'flex', flexDirection: 'column', zIndex: 30 }}>
      ...
      <div style={{ padding: '16px 16px 24px', display: 'flex', alignItems: 'center', gap: 12, justifyContent: 'space-between' }}>
        <button onClick={onCapture} aria-label="Aus Galerie wählen" style={{
          ...
          <span style={{ font: `600 9px ${F}`, color: 'color-mix(in srgb, var(--th-card) 85%, transparent)' }}>Galerie</span>
        </button>
        <button onClick={onCapture} aria-label="Aufnahme" style={{
          width: 74, height: 74, borderRadius: 37, background: 'var(--th-card)',
        ...
        <button onClick={onSkip} aria-label="Überspringen" style={{
          ...
          <span style={{ font: `600 9px ${F}`, color: 'color-mix(in srgb, var(--th-card) 85%, transparent)' }}>Skip</span>
        </button>
      </div>
  ...
  return (
    <>
      ...
      <div style={{ padding: '18px 20px 0' }}>
        ...
        <div style={{
          background: 'var(--th-card)', borderRadius: 12, padding: '12px 14px',
          border: '1px solid var(--th-border)',
          ...
          {PHOTO_STEPS.map((s, i) => {
            ...
            return (
              <button key={s.n} onClick={() => onEdit(i)} style={{
                ...
                background: done ? 'linear-gradient(135deg,#7c3aed22,#5b21b611)' : 'var(--th-low)',
                border: `1px solid ${done ? 'rgba(124,58,237,.3)' : 'var(--th-border-md)'}`,
                ...
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                  <div style={{
                    ...
                    background: done ? '#7c3aed' : 'var(--th-card)',
                    color: done ? '#fff' : COLORS.muted,
                    border: done ? 'none' : '1px solid var(--th-border-strong)',
                    font: `800 11px ${F}`,
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                  }}>{s.n}</div>
                  {done
                ...
                <div>
                  <div style={{
                    ...
                    background: done ? '#fff' : 'var(--th-border)',
                    display: 'flex', alignItems: 'center', justifyContent: 'center',
                    marginBottom: 6,
                  }}>
      ...
      <div style={{ padding: '22px 20px 0' }}>
        <button
          ...
          style={{
            ...
            background: complete ? '#7c3aed' : 'var(--th-low)',
    ...
    <>
      ...
      <div style={{ padding: '12px 20px 0' }}>
        <button disabled={remaining === 0} onClick={remaining === 0 ? undefined : onOpenScan} style={{
          width: '100%', height: 46, borderRadius: 12,
          background: remaining === 0 ? 'var(--th-low)' : COLORS.primary,
        ...
        <div style={{ display: 'flex', gap: 6, overflowX: 'auto', scrollbarWidth: 'none', margin: '0 -20px', padding: '0 20px 2px' }}>
          {tabs.map(t => {
            ...
            return (
              <button key={t.k} onClick={() => setFilter(t.k)} style={{
                flexShrink: 0, height: 32, padding: '0 12px', borderRadius: 16,
                background: on ? COLORS.primary : 'var(--th-card)',
                color: on ? 'var(--th-card)' : COLORS.text,
                border: on ? 'none' : '1px solid rgba(25,28,29,.09)',
                font: `700 12px ${F}`, cursor: 'pointer',
              }}>
      ...
      <div style={{ padding: '12px 20px 0' }}>
        <div style={{ background: 'var(--th-card)', borderRadius: 14, border: '1px solid var(--th-border)', overflow: 'hidden' }}>
          ...
          {items.map((r, i) => {
            ...
            const label = MARKET_LABELS[r.market] || r.market;
            const badge = r.status === 'approved'
              ? { bg: 'var(--th-primary-tint-strong)',  color: COLORS.primary, icon: 'check-circle', text: 'Bestätigt' }
              : r.status === 'pending'
              ? { bg: 'rgba(245,158,11,.1)',  color: '#d97706',      icon: 'clock-outline',text: 'In Prüfung' }
              : { bg: 'rgba(220,38,38,.1)',   color: '#dc2626',      icon: 'close-circle', text: 'Abgelehnt' };
            return (
