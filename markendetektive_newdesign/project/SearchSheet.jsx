      ...
      <div onClick={(e)=>e.stopPropagation()} style={{
        ...
        <div style={{ padding: '4px 20px 14px', display: 'flex', gap: 10, alignItems: 'center', flexShrink: 0 }}>
          <div style={{
            ...
            background: 'var(--th-card)', borderRadius: 24, border: `1px solid rgba(25,28,29,.1)`,
          ...
          <button onClick={()=>submit()} style={{
            ...
            background: query.trim() ? SS_C.primary : 'var(--th-primary-tint-strong)',
              ...
              <div style={{ display: 'flex', flexWrap: 'wrap', gap: 8 }}>
                {recents.map(r => (
                  <div key={r} style={{
                    ...
                    background: 'var(--th-card)', borderRadius: 20,
